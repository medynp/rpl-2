        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/aboutme"  :active="request()->is('aboutme')">About Us</x-nav-link>
              ...
              <div>
                <button type="button" @click="isOpen = !isOpen"
                 class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="h-8 w-8 rounded-full" src="https://i.pinimg.com/736x/1e/86/56/1e86568d9736ba40cc6197c00cd98253.jpg" alt="">
                </button>
              </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-full" src="https://i.pinimg.com/736x/1e/86/56/1e86568d9736ba40cc6197c00cd98253.jpg" alt="">
          </div>
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">James Lee</div>
            <div class="text-sm font-medium leading-none text-gray-400">LeeJihoon@godspeed.com</div>
          </div>
